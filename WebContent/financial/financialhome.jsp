<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
	<%if(request.getSession().getAttribute("userId")==null||((Integer)request.getSession().getAttribute("type"))!=2){ 
...
<script type="text/javascript">
    function autoHeight1(){
        var iframe = document.getElementById("financial_info_frame");//这里括号内的"runtime"其实就是上面的ID，要改成自己上面填写的ID。
...
<body>
   <div class="navbar navbar-inverse" role="navigation" style="height: 80px;">
    ...
    <div class="template-page-wrapper">
      <div class="navbar-collapse collapse templatemo-sidebar">
        <ul class="templatemo-sidebar-menu">
          ...
          <li class="active" id="financial_info_tab"><a href="#" id="financial_info_link"><i class="fa fa-male"></i>查看专家账户信息</a></li>
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
         	...
         	<div id="admin_person" style="display:block">
				<iframe  id="financial_info_frame" name="financial_info_frame" src="financial_info.jsp" frameborder="0" scrolling="auto" style="border:0px;width:100%;" onload="autoHeight1();"></iframe> 
			</div>
    ...
    <script type="text/javascript">
       $("#financial_info_frame").load(function () {
